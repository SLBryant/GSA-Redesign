...
<section id="sub-section" class="row tabs-section">
    ...
    <nav class="col-sm-3 tab-navigation">
        <ul class="nav" role="tablist">
            ...
            <li><a href="#lorem" role="tab" data-toggle="tab">Lorem Ipsum</a></li>
        </ul>
    </nav>
    <div class="col-sm-9 tab-content">
        <div class="tab-pane active" id="searchAdvantage">
            <form class="form-inline"><div class="form-group"><label class="sr-only" for="form-control">Search GSA Advantage</label> <input class="form-control col-sm-12" type="text" placeholder="Search GSA Advantage" /> <button id="searchAdvantageSubmit" class="btn gsa-btn" type="submit"><span class="glyphicon glyphicon-search"> </span></button>The online marketplace for Federal Procurement. Now also available to State and Local Employees.</div></form>
        </div>
