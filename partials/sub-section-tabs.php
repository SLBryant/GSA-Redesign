...
<section id="sub-section" class="row tabs-section">
    ...
    <div class="col-md-9 tab-content">
        <div class="tab-pane active" id="tab-A">Content ABC</div>
        <div class="tab-pane" id="tab-B">Wiiii</div>
        <div class="tab-pane" id="tab-C">Ouch</div>
        <div class="tab-pane" id="tab-D">Boom</div>
    </div>
</section>